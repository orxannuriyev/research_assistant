...
class ResearchEngine:
    ...
    async def _call_orchestrator_async(self, query: str, sources: list[str]) -> Any:
        """Finds and executes the fetch method on Orchestrator safely in async mode."""
        res = None
    ...
    async def research_async(
        ...
        raw_results = await self._call_orchestrator_async(clean_question, list(target_sources))
    ...
    def research(
        ...
        try:
            ...
            return loop.run_until_complete(self.research_async(question, sources, use_cache))